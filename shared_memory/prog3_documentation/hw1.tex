...
\newcommand{\hmwkTitle}{Homework 3\\ (Shared Memory Portion)} % Assignment title
\newcommand{\hmwkDueDate}{Sunday,\ May\ 1,\ 2015} % Due date
\newcommand{\hmwkClass}{CSC\ 456} % Course/class
\newcommand{\hmwkClassTime}{ } % Class/lecture time
\newcommand{\hmwkClassInstructor}{ Dr. Karlsson} % Teacher/lecturer
\newcommand{\hmwkAuthorName}{Lisa Woody} % Your name
